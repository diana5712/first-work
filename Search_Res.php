...
<html lang="ru">
  ...
  <?php
	...
	<?php
      ...
      $result = mysql_query("SELECT * FROM info WHERE section_type='$_POST[section_type]' OR id='$_POST[section_type]' OR city='$_POST[section_type]' OR section_name='$_POST[section_type]'");
    ?> 
      ...
      while($myrow = mysql_fetch_array($result))
   {
    ...
    if(section_type != $_POST['section_type'])
      {
echo <<<HEREF
    <div class = "text4">
There is no information by "$_POST[section_type]"!
    </div>
HEREF;
      }
      ?>
